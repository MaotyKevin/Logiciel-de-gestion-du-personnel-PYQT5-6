...
class DonutChartViewCategory(QWidget):
    ...
    def update_chart(self):
        data = self.controller.display_donut_chart_category()
        labels = [category[0] for category in data]
        sizes = [category[1] for category in data]
...
if __name__ == '__main__':
    ...
    view = DonutChartViewCategory("data\my_database.sqlite")
    view.show()
    sys.exit(app.exec_())
