...
class DonutChartViewSC(QWidget):
    ...
    def update_chart(self):
        data = self.controller.display_donut_chart_SC()
        labels = [SCcategory[0] for SCcategory in data]
        sizes = [SCcategory[1] for SCcategory in data]
...
if __name__ == '__main__':
    ...
    view = DonutChartViewSC("data\my_database.sqlite")
    view.show()
    sys.exit(app.exec_())
