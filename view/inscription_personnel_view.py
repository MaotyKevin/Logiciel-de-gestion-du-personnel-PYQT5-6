...
class InscriptionPersonnelForm(QWidget):
    ...
    def envoi(self):
        ...
        date_cin = self.stepOne.date_cin_edit.date().toString("dd-MM-yyyy")
        lieu_cin = self.stepOne.lieu_cin_edit.text()
        contact = self.stepOne.contact_edit.text()
        date_naissance = self.stepOne.date_naissance_edit.date().toString("dd-MM-yyyy")
        ...
        du = self.stepTwo.du_edit.date().toString("dd-MM-yyyy")
        date_visite_medicale = self.stepTwo.date_visite_medicale_edit.date().toString("dd-MM-yyyy")
        date_accueil_securite = self.stepTwo.date_accueil_securite_edit.date().toString("dd-MM-yyyy")
        msb = self.stepTwo.msb_edit.date().toString("dd-MM-yyyy")
        consignation = self.stepTwo.consignation_edit.date().toString("dd-MM-yyyy")
        ms = self.stepTwo.ms_edit.date().toString("dd-MM-yyyy")
        ve_omsi = self.stepTwo.ve_omsi_edit.date().toString("dd-MM-yyyy")

        
        fonction = self.stepThree.fonction_edit.text()
        deuxieme_fonction = self.stepThree.deuxieme_fonction_edit.text()
        date_debut = self.stepThree.date_debut_edit.date().toString("dd-MM-yyyy")
        date_fin = self.stepThree.date_fin_edit.date().toString("dd-MM-yyyy")
        cause_depart = self.stepThree.cause_depart_edit.text()

        date_equipement = self.stepThree.date_equipement_edit.date().toString("dd-MM-yyyy")
